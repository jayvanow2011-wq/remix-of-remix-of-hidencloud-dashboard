const state = { location: "Frankfurt", ram: 8, cpu: 4, disk: 60 };
function price(s) {
...
export function bindBuilder(root) {
    ...
    bindRange("cpu", "");
    bindRange("disk", " GB");
    const loc = root.querySelector("#location");
    ...
    root.querySelector("#deploy").addEventListener("click", () => {
        root.querySelector("#deploy-msg").textContent =
